...
describe('server', function()  {
    ...
    describe('GET /', function() {
        ...
        it('should return a list songs', function() {
          return request(server).get('/').then(res => {
                expect(res.body).toEqual({ api: "Welcome to Our Spotify Song Selector:",  id: 1, song_name: 'Blinding Lights', artist_name: 'The Weekend', duration: 3.21, genre: 'R&B/Soul', song_url: 'https://open.spotify.com/album/2ZfHkwHuoAZrlz7RMj0PDz',
